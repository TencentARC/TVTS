...
class Multi_BaseTrainer_dist:
    ...
    def __init__(self, args, model, loss, metrics, optimizer, config, writer=None, init_val=False):
        ...
        self.base_lr = optimizer.state_dict()['param_groups'][0]['lr']
        if self.args.rank == 0:
            print('base learning rate %f' % self.base_lr)
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        checkpoint = torch.load(resume_path, map_location='cuda:{}'.format(self.args.local_rank))
