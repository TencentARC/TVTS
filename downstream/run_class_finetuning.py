...
from video_encoder import VisionTransformer
...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        state_dict = {k.replace('module.video_model.', ''): v for k, v in state_dict.items() if
                      'module.video_model.' in k}

    # need to check if only head is different
