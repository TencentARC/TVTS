...
def run():
    ...
    if config['trainer']['neptune']:
        ...
        writer = None
    trainer = Trainer_TVTS(args, model, loss, metrics, optimizer,
                           config=config,
...
if __name__ == '__main__':
    ...
    args.add_argument('-sc', '--schedule', nargs='+', type=int, default=[12, 16])
